...
int main(int argc, char const *argv[])
{
  ...
  std::cout<<"a) The number of icosahedral clusters is "<<RED<<nClu<<RESET<<std::endl;
  std::cout<<"b) The number of particles in icosahedra is "<<sum(sClu)<<std::endl; 
  std::cout<<"c) The number of 7A is "<<RED<<icosahedra.nsp5c<<RESET<<std::endl;
  char bufname[256];
